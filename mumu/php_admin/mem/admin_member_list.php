...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#999999">
  <tr align="center" class="text"> 
	...
	<td width="113" height="25" bgcolor="#f5f5f5">삭제</td>
  </tr>
  <?
    $scale=30;
    if ($page == ''){
	...
	$sql_2 = "select * from member where 1 $sear_char order by seq_num desc LIMIT $cline,$scale1 "; 
 ...
 ?>	  
  <tr bgcolor="#FFFFFF" class="text"> 
	...
	<td align="center"><a href="mem_del.php?m_num=<?=$list[seq_num]?>&page=<?=$page?>" onClick="return confirm('삭제를 하시게 되면 이 회원의 모든 정보가 삭제됩니다. \n삭제하시겠습니까?')">삭제</td>
  </tr>
  <?
    }
