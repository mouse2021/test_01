...
if($mode == "update"){
	$query = "select * from auct_category where id=$id";
...
<center>
<form name="form1" method="post" action="cate_insert.php">
  <table width="600" border="0" cellspacing="1" cellpadding="5">
   ...
   <tr class="hanamii">
    <td bgcolor="#D9D9D9" width="20%" align="center">사용여부</td>
	  <td bgcolor="#FFFFFF" width="80%">
       <select name="cancel_chk">
	    <option value="N" <? if($row[cancel_chk]=='N') echo"selected"; ?> >사용중</option>
	    <option value="Y" <? if($row[cancel_chk]=='Y') echo"selected"; ?>>비사용</option>
    </td>
   </tr>
  </table>
  <br>
