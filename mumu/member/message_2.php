     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="89" style="padding:16 0 0 25px"> 
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td ><img src="../img/message_title.gif" width="30" height="30" align="absmiddle" hspace="2">보낸쪽지함</td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0">
		  <tr bgcolor="CCCCCC"> 
		   ...
		   <td align="center" width="100" class="line2">받는이확인유무</td>
...
<?
 ...
 ?>
     <tr> 
       ...
       <td class="line">
	     <a href="message_view.php?mnum=<?=$rows2[mnum]?>&gb=2"><?=$msg_char?></a>
	   </td>
